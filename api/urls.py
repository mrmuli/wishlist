...
from viewsets import UserViewSet, BucketlistView, BucketlistDetail, BucketlisItemView, BucketlistitemDetail
...
urlpatterns = [
    ...
    url(r'^bucketlists/(?P<id>[0-9]+)/items/(?P<pk>[0-9]+)/$', BucketlistitemDetail.as_view(), name='item-detail'),
]
